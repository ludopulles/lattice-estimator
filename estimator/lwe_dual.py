...
from .util import local_minimum, early_abort_range, binary_search, log_gh
        ...
        **kwds,
        ...
        def g(beta):
            return DualHybridv2.cost(
                beta, params, num_targets, red_shape_model, red_cost_model, log_level, **kwds
            )
        ...
        opt_beta = 40 if f(40) else binary_search(f, 40, d)
        cost = g(opt_beta)
        cost["|S|"] = num_targets
        return cost
        ...
        if params.Xs.is_sparse:
            def cost_h(h):
                ...
                cost_ = cls.cost_zeta_(
                    reduced_params, search_space, red_shape_model, red_cost_model, log_level, **kwds
                )
